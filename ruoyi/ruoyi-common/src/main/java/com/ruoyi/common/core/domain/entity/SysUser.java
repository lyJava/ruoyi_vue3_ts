...
public class SysUser extends BaseEntity {
     ...
     * 岗位名称集合
     */
    private List<String> postNameArray;
    ...
    public List<String> getPostNameArray() {
        return postNameArray;
    }

    public void setPostNameArray(List<String> postNameArray) {
        this.postNameArray = postNameArray;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("roleNames", getRoleNameArray())
                .append("postNames", getPostNameArray())
                .toString();
    }
}
