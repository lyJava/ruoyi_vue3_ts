<template>
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24">
        <blockquote class="text-warning" style="font-size: 16px;line-height: 40px;">
          领取阿里云通用云产品1888优惠券
          <br />
          <el-link
      ...
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        ...
        <p>
          <el-link
            ...
            icon="position"
            target="_blank"
            ><span class="table_link_text">访问码云</span></el-link
          >
          <el-link
            :underline="false"
            ...
            icon="position"
            target="_blank"
            ><span class="table_link_text">访问主页</span></el-link
          >
        </p>
      </el-col>
